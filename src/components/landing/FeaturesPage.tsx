...
const features = [
  ...
  { icon: "💬", title: "AIコーチ（4キャラから選択）", desc: "あなたの全データを把握したAIコーチが相談相手に。カレオ・なごま・リク・シオリの4種類から好みのコーチを選べる。面接対策・悩み相談・自己分析の言語化をチャットで。" },
...
const faqs = [
  ...
  { q: "無料で使えますか？", a: "無料プランで始められます。企業・ES・面接管理など基本機能はすべて無料。AIの高度な分析（PDCA無制限・週次コーチ等）は ¥480/月のProプラン、もしくは期間限定パック（¥980/30日）で利用できます。" },
