...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 9v7.5" />
      </svg>
    ),
  },
];
...
export function Sidebar() {
  ...
  return (
    <aside
      className={`flex flex-col sticky top-0 h-screen bg-[#14103A] transition-all duration-200 shrink-0 ${
        collapsed ? "w-14" : "w-56"
      }`}
    >
      {/* ロゴ + 折り畳みボタン */}
      <div className={`border-b border-white/10 flex items-center ${collapsed ? "justify-center px-0 py-4" : "px-4 pt-5 pb-4"}`}>
        {!collapsed && (
      ...
      {/* ボトムナビ */}
      <div className={`border-t border-white/10 py-3 ${collapsed ? "px-1.5" : "px-3"}`}>
