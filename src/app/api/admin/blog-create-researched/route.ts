...
学生は完全無料で使えます。「無料版」「有料版」という区別はなく、登録した学生は全機能を無料で利用できます。記事内でCareoに言及する際は「無料で使える」「学生は完全無料」のように表現し、「無料版のCareo」という書き方はしないこと。
...
{"title":"記事タイトル","description":"メタディスクリプション（120〜160文字）","tags":["タグ1","タグ2","タグ3"],"reading_time_min":読了時間分数,"focus_keyphrase":"この記事で5〜8回登場させるキーフレーズ（助詞を含む自然な日本語のフレーズにすること。例: 「28卒の就活スケジュールを把握する方法」「OB訪問で聞くべき質問の選び方」）"}
