...
2. 外部引用: 厚生労働省・経団連・マイナビ就職白書・リクルートワークス研究所などの信頼できる公的データや調査を必ず1つ引用し、出典URLを<a href="..." target="_blank" rel="noopener noreferrer">出典名</a>でリンクする
3. 比較表: HTMLの<table>タグで比較・整理表を最低1つ入れる
4. 視覚的要素: 数値データは<div class="blog-stat-bar">などで棒グラフ的に表現するか、<blockquote>で強調する
5. 他社サービス・ツールのリンク必須: StrengthsFinder・Notion・マイナビ・リクナビ・OpenES・OfferBox・キャリアパーク・ビズリーチキャンパスなど他社サービスや企業を名指しで紹介・比較する場合は、必ずその公式サイトURLを<a href="https://..." target="_blank" rel="noopener noreferrer">サービス名</a>としてリンクすること。URLが不明な場合はその企業・サービスを記事に含めない
