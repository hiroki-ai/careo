...
① 今日のX投稿1本の下書き（就活情報を届けながらCareoへの自然な認知につながる内容）
...
就活生の視点から「ここを直すと使いやすくなる・信頼感が上がる・離脱が減る」ポイントを選んでください。
